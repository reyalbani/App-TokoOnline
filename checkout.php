        ...
        <div class="container">
            ...
            <form method="post">
                ...
                <div class="col-md-12 form-group">
                    ...
                    <textarea class="form-control" name="alamat_pengiriman" placeholder="masukan alamat lengkap pengiriman(termasuk kode pos)"></textarea><br>
                </div>
                ...
                <button class="btn btn-primary" name="checkout"><i class="glyphicon glyphicon-export"></i> Checkout</button>
            </form>
